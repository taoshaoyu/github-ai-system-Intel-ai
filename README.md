![Intel AI logo](/img/thumbnail.jpg "Intel AI")
...
* https://github.com/intel/certified-developer

## Drivers
* Android Neural Networks HAL with OpenVINO
  * https://github.com/intel/nn-hal

* OpenCL and L0 Compute Drivers, `ocloc` compiler
...
* Intel® Edge AI Performance Evaluation Toolkit
  * https://github.com/intel/Intel-Edge-AI-Performance-Evaluation-Toolkit
...
### For [Triton](https://triton-lang.org/main/index.html)
* https://github.com/intel/intel-xpu-backend-for-triton
### For [Chainer](https://chainer.org/)
* https://github.com/intel/ideep
### For [Deepspeed](https://www.deepspeed.ai/)
* https://github.com/intel/intel-extension-for-deepspeed
### For [OpenXLA](https://openxla.org/)
* https://github.com/intel/intel-extension-for-openxla 
### For [HuggingFace Transformers](https://huggingface.co/docs/transformers)
